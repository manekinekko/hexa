...
module.exports = function () {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var shouldOverrideConfigFile, project, features, featuresConfiguration, features_1, features_1_1, feature, featureImplementation, config, error_1, e_1_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!utils_1.isProjectFileExists()) return [3 /*break*/, 2];
                    return [4 /*yield*/, prompt_1.askIfOverrideProjectFile()];
                case 1:
                    shouldOverrideConfigFile = _b.sent();
